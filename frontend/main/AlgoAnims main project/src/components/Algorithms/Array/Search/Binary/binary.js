export function binarySearchscript() {
    let inputArray = [];
    ...
    document.querySelector("#searchbtn").addEventListener("click", enter);
    function enter() {
    ...
    document.querySelector(".searchbtn").addEventListener("click" , binarysearch)
}