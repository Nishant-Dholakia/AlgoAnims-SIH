...
function Signup() {
  ...
  useEffect(() => {
    ...
    if (loginBox) {
      tl.from(loginBox, { y: 50, opacity: 0, duration: 1.5, delay: 0.5 });
    }

    if (signupBox) {
      tl.from(signupBox, { y: 50, opacity: 0, duration: 1.5, delay: 0.8 });
    }

    if (algoanimsHeading) {
      tl.from(algoanimsHeading, { y: -50, opacity: 0, duration: 1.5, delay: 0.8 });
    }
