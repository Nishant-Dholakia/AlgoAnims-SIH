...
var BinarySearchTreeNode = class _BinarySearchTreeNode extends BinaryTreeNode_default {
  /**
  ...
  insert(value) {
    ...
    if (value < this.value) {
      ...
      this.setLeft(new _BinarySearchTreeNode(value));
      return;
    }
    if (this.right) {
    ...
    this.setRight(new _BinarySearchTreeNode(value));
  }
  /**
